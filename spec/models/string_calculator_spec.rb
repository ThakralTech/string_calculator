...
RSpec.describe StringCalculator, type: :model do
    ...
    it 'raises an exception for negative numbers' do
      expect { addition.add('1,-2') }.to raise_error('negatives not allowed: -2')
    end
